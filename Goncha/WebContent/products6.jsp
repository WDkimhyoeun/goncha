...
<%@ page import="dao.ProductRepository6"%>
<html>
<head>
...
<div id = "head2">
	...
	<%
		ProductRepository6 dao = ProductRepository6.getInstance();
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-3">
				...
				<p><a href="./product6.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
