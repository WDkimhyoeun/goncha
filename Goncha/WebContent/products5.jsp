...
<%@ page import="dao.ProductRepository5"%>
<html>
<head>
...
<div id = "head2">
	...
	<%
		ProductRepository5 dao = ProductRepository5.getInstance();
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-3">
				...
				<p><a href="./product5.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
