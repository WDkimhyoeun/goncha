...
<%@ page import="dao.ProductRepository10"%>
<html>
<head>
...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			...
			<h3 class="display-5">스무디&크러쉬</h3>
		</div>
	</div>
	<%
		ProductRepository10 dao = ProductRepository10.getInstance();
		ArrayList<Product> listOfProducts = dao.getAllProducts();
	%>
	
<div>
	<ul>
			<li><a href="./products.jsp" style="color:black"><span>시즌 메뉴</span></a></li>
			<li><a href="./products2.jsp"style="color:black"><span>베스트 콤비네이션</sapn></a></li>
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-3">
				...
				<p><a href="./product10.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
