...
<%@ page import="dao.ProductRepository9"%>
<html>
<head>
...
<div id = "head2">
	...
	<%
		ProductRepository9 dao = ProductRepository9.getInstance();
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-3">
				...
				<p><a href="./product9.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
