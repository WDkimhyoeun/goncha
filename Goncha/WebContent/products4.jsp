...
<%@ page import="dao.ProductRepository4"%>
<html>
<head>
...
<div id = "head2">
	...
	<%
		ProductRepository4 dao = ProductRepository4.getInstance();
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-3">
				...
				<p><a href="./product4.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
