...
<%@ page import="dao.ProductRepository13"%>
<html>
<head>
...
<div id = "head2">
	...
	<%
		ProductRepository13 dao = ProductRepository13.getInstance();
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-3">
				...
				<p><a href="./product13.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
