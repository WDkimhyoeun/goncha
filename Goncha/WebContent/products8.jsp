...
<%@ page import="dao.ProductRepository8"%>
<html>
<head>
...
<div id = "head2">
	...
	<%
		ProductRepository8 dao = ProductRepository8.getInstance();
	...
	<div class="container">
		<div class="row" align="center">
			...
			<img src="${pageContext.request.contextPath}/resources/product_img/<%=product.getFilename()%>" style="width: 100%">
				...
				<p><a href="./product8.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
