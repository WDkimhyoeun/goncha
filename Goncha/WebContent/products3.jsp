...
<%@ page import="dao.ProductRepository3"%>
<html>
<head>
...
<div id = "head2">
	...
	<%
		ProductRepository3 dao = ProductRepository3.getInstance();
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-3">
				...
				<p><a href="./product3.jsp?id=<%=product.getProductId()%>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
